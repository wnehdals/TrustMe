...
class SelectedFoodAdapter(private val context: Context, private val onClickStore: (Store, Int) -> Unit = { selectedItem, position -> }): RecyclerView.Adapter<SelectedFoodAdapter.ViewHolder>() {
